...
var selectedItem; 
var hidePropertyBtn;
var DiagramClientSideEvents = require("./events.js");
var DropDownDataSources = require("./dropdowndatasource.js");
var PropertyChange = require("./properties.js");
...
const doors = [
  { id:'Doorclose',addInfo:'Door close', shape: { type: 'Path', data: 'M1 71L1 79L72 79V71M1 71L72 71M1 71C1 32.3401 32.3401 1 71 1H72V71' }},  
  { id:'Doubledoorclose',addInfo:'Double door close', shape: { type: 'Path', data:"M143 71V79L1 79L1 71M143 71L1 71M143 71V1H142C103.34 1 72 32.3401 72 71M143 71H72M1 71L1 1H2C40.6599 1 72 32.3401 72 71M1 71L72 71M72 78.5V71"}},
  { id:'Room',addInfo:'Room', shape :{ type: 'Path', data:"M4 4H104V104H4V4Z"}},
  { id:'TRoom',addInfo:'T Room', shape :{ type: 'Path', data:"M4 4H273V145.749H192.981V250H71.25V110.312H4V4Z"}},
  { id:'LRoom',addInfo:'L Room', shape :{ type: 'Path', data:"M4 4H273V250H146.5V110.312H4V4Z"}},
  { id:'WallCorner',addInfo:'Wall Corner', shape :{ type: 'Path', data:"M104 4H4V104"}},
  { id:'WallCorner1',addInfo:'Wall Corner', shape :{ type: 'Path',data:'M0 100L100 100L100 0'}},
  { id:'Staircase',addInfo:'Staircase',dragSize:{width:64,height:25}, shape :{ type: 'Path', data:'M36 1V35M36 1L25 1M36 1H48M36 35H25M36 35H48M25 35L25 1M25 35H13L13 1L25 1M48 1V35M48 1H59M48 35H59M59 1V35M59 1H71M59 35H71M71 1V35M71 1H82M71 35H82M82 1V35M82 1H94M82 35H94M94 1V35M94 1H105M94 35H105M105 1V35M105 1H117V35H105M129 1V35L1 35L1 1L129 1Z'}},
  { id:'Staircase1',addInfo:'Staircase',dragSize:{width:64,height:25}, shape :{ type: 'Path', data:'M36 1V35M36 1L25 1M36 1H48M36 35H25M36 35H48M25 35L25 1M25 35H13L13 1L25 1M48 1V35M48 1H59M48 35H59M59 1V35M59 1H71M59 35H71M71 1V35M71 1H82M71 35H82M82 1V35M82 1H94M82 35H94M94 1V35M94 1H105M94 35H105M105 1V35M105 1H117V35H105M9 17.5H122M9 17.5C9 18.8807 7.88071 20 6.5 20C5.11929 20 4 18.8807 4 17.5C4 16.1193 5.11929 15 6.5 15C7.88071 15 9 16.1193 9 17.5ZM129 1V35L1 35L1 1L129 1ZM126 17.5L121.5 20.5311V14.4689L126 17.5Z'}},
  { id:'TWall',addInfo:'T Wall', shape :{ type: 'Path', data:"M106 4.00002L206 4.00004M106 4.00002L106 104M106 4.00002L0 4"}},
  { id:'Staircase2',addInfo:'Staircase',dragSize:{width:64,height:25}, shape :{ type: 'Path', data:'M1 17.4998L133 17.4998M121.177 0.869141L132.874 17.3083M121.582 34.7252L132.756 17.7252M121.5 0.999829V34.9998M109.5 0.999829V34.9998M97.5 0.999829V34.9998M85.5 0.999829V34.9998M73.5 0.999829V34.9998M61.5 0.999829V34.9998M49.5 0.999829V34.9998M37.5 0.999829V34.9998M25.5 0.999829L25.5 34.9998M13.5 0.999829L13.5 34.9998M133 0.999829V34.9998L1 34.9998L1 0.999824L133 0.999829Z'}},
  { id:'WindowGarden',addInfo:'Window Garden',dragSize:{width:76,height:29}, shape :{ type: 'Path', data:"M1.5 0H0V1.5V38.5H3V3H152V38.5H155V1.5V0H153.5H1.5ZM6.5 5H5V6.5V38.5H8V8H53V38.5H56V8H100V38.5H103V8H147V38.5H150V6.5V5H148.5H103H101.5H100H56H54.5H53H6.5Z"}},
...
const kitchen=[
  ...
  { id:'DoubleSink',addInfo:'Double Sink',dragSize:{width:30,height:30},shape :{ type: 'Path', data:'M1 9C1 4.58172 4.58172 1 9 1H115C119.418 1 123 4.58172 123 9V41C123 45.4183 119.418 49 115 49H9C4.58172 49 1 45.4183 1 41V9Z M7 13C7 10.7909 8.79086 9 11 9H55C57.2091 9 59 10.7909 59 13V37C59 39.2091 57.2091 41 55 41H11C8.79086 41 7 39.2091 7 37V13Z M65 13C65 10.7909 66.7909 9 69 9H113C115.209 9 117 10.7909 117 13V37C117 39.2091 115.209 41 113 41H69C66.7909 41 65 39.2091 65 37V13Z M35 25.5C35 26.8807 33.8807 28 32.5 28C31.1193 28 30 26.8807 30 25.5C30 24.1193 31.1193 23 32.5 23C33.8807 23 35 24.1193 35 25.5Z M93 25.5C93 26.8807 91.8807 28 90.5 28C89.1193 28 88 26.8807 88 25.5C88 24.1193 89.1193 23 90.5 23C91.8807 23 93 24.1193 93 25.5Z M64.3638 10.4863C64.3638 10.4863 65.071 10.4863 65.7781 9.77915C66.4852 9.07204 66.4852 8.36493 66.4852 8.36493L74.4865 15.2232C75.5104 16.1009 75.5705 17.6644 74.6169 18.618C73.6633 19.5716 72.0998 19.5115 71.2221 18.4876L64.3638 10.4863Z M65.4246 4.47532C66.7915 5.84216 66.7915 8.05823 65.4246 9.42507C64.0578 10.7919 61.8417 10.7919 60.4749 9.42507C59.108 8.05823 59.108 5.84216 60.4749 4.47532C61.8417 3.10849 64.0578 3.10849 65.4246 4.47532Z'}},
]

// Defines symbols for bathroom shapes
const bathRoom =[
  { id:'Toilet1',addInfo:'Toilet',dragSize:{width:30,height:30}, shape :{ type: 'Path', data: 'M46.4065 37.9425C46.4065 55.0951 36.823 69.0002 25.0011 69.0002C13.1792 69.0002 3.5957 55.0951 3.5957 37.9425C3.5957 30.1141 5.2059 23.4623 8.5 18C8.61402 18 25 18 25 18H41.2425C44.5366 23.4623 46.4065 30.1141 46.4065 37.9425Z M41.2161 43.5006C41.2161 53.9728 33.9559 62.4621 24.9999 62.4621C16.0439 62.4621 8.78369 53.9728 8.78369 43.5006C8.78369 33.0284 16.0439 24.5391 24.9999 24.5391C33.9559 24.5391 41.2161 33.0284 41.2161 43.5006Z M1 3.61538C1 2.17095 2.17095 1 3.61538 1H46.3846C47.8291 1 49 2.17095 49 3.61538V15.3846C49 16.8291 47.8291 18 46.3846 18H3.61538C2.17095 18 1 16.8291 1 15.3846V3.61538Z M26.9995 9C26.9995 10.1046 26.1041 11 24.9995 11C23.8949 11 22.9995 10.1046 22.9995 9C22.9995 7.89543 23.8949 7 24.9995 7C26.1041 7 26.9995 7.89543 26.9995 9Z M31 33C31 37.4183 28.3137 41 25 41C21.6863 41 19 37.4183 19 33C19 28.5817 21.6863 25 25 25C28.3137 25 31 28.5817 31 33Z '}},
  { id:'Toilet2',addInfo:'Toilet',dragSize:{width:30,height:30}, shape :{ type: 'Path', data:'M46.989 33.0731C46.989 53.4671 37.3818 69.9996 25.5307 69.9996C13.6795 69.9996 4.07227 53.4671 4.07227 33.0731C4.07227 19.1497 4 18 4 18C4.17549 18.0144 15.9306 18.2553 26.5002 17.9993C36.1582 17.7654 46.989 17.9999 46.989 17.9999C46.989 17.9999 46.989 21.6119 46.989 33.0731Z M41 44.5C41 54.7173 34.0604 63 25.5 63C16.9396 63 10 54.7173 10 44.5C10 34.2827 16.9396 26 25.5 26C34.0604 26 41 34.2827 41 44.5Z M1 3.61538C1 2.17095 2.17095 1 3.61538 1H46.3846C47.8291 1 49 2.17095 49 3.61538V15.3846C49 16.8291 47.8291 18 46.3846 18H3.61538C2.17095 18 1 16.8291 1 15.3846V3.61538Z M26.9995 9C26.9995 10.1046 26.1041 11 24.9995 11C23.8949 11 22.9995 10.1046 22.9995 9C22.9995 7.89543 23.8949 7 24.9995 7C26.1041 7 26.9995 7.89543 26.9995 9Z M31 34C31 38.4183 28.3137 42 25 42C21.6863 42 19 38.4183 19 34C19 29.5817 21.6863 26 25 26C28.3137 26 31 29.5817 31 34Z'}},
...
height: '100%',
palettes: [
    { id: 'door', expanded: true, symbols: doors, iconCss: 'e-ddb-icons e-flow', title: 'Doors and Walls' },
    ...
    getNodeDefaults: function (node) {
      if(node.id === 'Doorclose'||  node.id === 'Doubledoorclose')
      {
        node.width = 25;
        node.height = 25;
      }
      else if(node.id ==='CircleStudyTable'||node.id ==='CircularTableforTwo' ||node.id ==='CircleStudyTable1' ||node.id ==='CircleStudyTable2' ||node.id ==='CircleStudyTable3'){
        node.width = 27;
        node.height = 27;
      }
      else if(node.id ==='CircleDiningTable'){
        node.width = 30;
        node.height = 30
      }
      else if(node.id ==='RectangleDiningTable'){
        node.width = 30;
        node.height = 30;
      }
      else if(node.id ==='OblongDiningTable' ||node.id ==='RectangleDiningTable'|| node.id ==='OvalDiningTable' ){
        node.width = 50;
        node.height = 30;
      }
      else if(node.id === 'RectangularTableforTwo'){
        node.width = 26;
        node.height = 30;
      }
      else if(node.id === 'RectangleStudyTable'  || node.id === 'RectangleStudyTable1' )
      {
        node.width = 35;
        node.height = 22;
      }
      else if(node.id ==='SmallGasRange')
      {
        node.width = 50;
        node.height =25;
      }
      else if(node.id === 'LargeGasRange' ||node.id ==='LargeGasRange1'  )
      {
        node.width = 50;
        node.height = 25;
      }
      else if(node.id ==='Refrigerator' ||node.id ==='WaterCooler')
      {
        node.width = 25;
        node.height = 25;
      }
      else if(node.id ==='Doublebed' ||node.id ==='Doublebed1')
      {
        node.width = 36;
        node.height = 30;
      }
      else if(node.id ==='Singlebed' ||node.id ==='Singlebed1')
      {
        node.width = 19;
        node.height = 30;
      }
      else if(node.id ==='BookCase' )
      {
        node.width = 40;
        node.height = 20;
      }
      ...
      else if(node.id ==='LargePlant' ||node.id ==='SmallPlant'||node.id ==='Lamplight')
      {
        node.width = 20;
        node.height =20;
      }
      ...
      else if(node.id ==='FlatTV' ||node.id ==='FlatTV1')
      {
        node.width = 65;
        node.height =12;
      }
      ...
      else if(node.id ==='Sofa' ||node.id ==='DoubleSofa')
      {
        node.width = 50;
        node.height =25;
      }
      
      else if(node.id ==='SingleSofa'|| node.id ==='Couch')
      {
        node.width = 25;
        node.height = 25;
      }
      ...
      else if( node.id ==='WindowGarden' )
      {
        node.width = 60;
        node.height =10;
      }
      else if(node.id ==='LRoom' || node.id ==='WallCorner1'){
        node.width = 45;
        node.height =40;
      }
      else if(node.id ==='TWall'){
        node.width = 45;
        node.height = 30;
      }
      else if(node.id ==='Room' || node.id ==='TRoom'  || node.id ==='WallCorner'||  node.id ==='Elevator')
      {
        node.width = 45;
        node.height =38;
      }
      ...
      else if(node.id === 'CornerShower'|| node.id === 'Shower'){
        node.width = 36; 
        node.height = 35;
      }
      else if(node.id === 'WashBasin1'){
        node.width = 25;
        node.height = 25;
      }
      else if(node.id === 'WashBasin2' || node.id === 'WashBasin3'|| node.id === 'WashBasin5' || node.id === 'WashBasin6'){
        node.width = 30; 
        node.height = 22;
      }
      else if(node.id === 'DoubleSink4' || node.id === 'DoubleSink'|| node.id === 'DoubleSink1' || node.id === 'DoubleSink2'){
        node.width = 50; 
        node.height = 22;
      }
      else if(node.id === 'Refrigerator'|| node.id === 'WaterCooler' )
      {
        ...
        else if(node.id === 'BathTub' || node.id === 'BathTub1' || node.id === 'BathTub2' || node.id === 'BathTub3' || node.id === 'BathTub4'){
          node.width = 40;
          node.height =22;
        }
        else {
...
//Initialization of diagram
  var diagram = new ej.diagrams.Diagram({
    ...
    historyChange: function (args) { diagramClient.historyChange(args); },
    selectionChange: function (args) { diagramClient.selectionChange(args); },
    positionChange: function (args) { diagramClient.positionChange(args); },
    sizeChange: function (args) { diagramClient.sizeChange(args); },
    rotateChange: function (args) { diagramClient.rotateChange(args); },
    dragEnter:function (args) { diagramClient.dragEnter(args); },
    created: function (args) { diagramClient.created(args);},
...
let menuBar = new ej.navigations.Menu({
  content: 'Menu',
...
function toolbarInsertClick(args) {
  const commandType = (args.item ? args.item.text : args.target.id).replace(/[' ']/g, '').toLowerCase();
  if (diagram.nodes.length > 0) {
    switch (commandType) {
      case 'insertlink':
        ...
        break;
      case 'insertimage':
        openUploadBox(false, '.jpg,.png,.svg');
        break;
    }
  }
}
...
function getUploadButtons() {
  var buttons = [];
  buttons.push({
      click:utilityMethods.btnCancelClick.bind(this),
...
var pageSettingsList = new ej.dropdowns.DropDownList({
  ...
  change: function (args) { utilityMethods.paperListChange(args) },
...
document.getElementById("pagePortrait").onclick = (args)=>{
  utilityMethods.pageOrientationChange(args)
  document.getElementById('pageLandscape').classList.remove('e-active');
}
...
var pageWidth = new ej.inputs.NumericTextBox({
  ...
  change: function (args) {utilityMethods.pageDimensionChange(args); }
});
...
var pageBgColor = new ej.inputs.ColorPicker({
  ...
  change: function (args) { utilityMethods.pageBackgroundChange1(args); }
});
...
var showPageBreaks = new ej.buttons.CheckBox({ label: 'Page Breaks', checked: diagram.pageSettings.pageBreaks, change: function (args) { utilityMethods.pageBreaksChange(args); } });
...
var nodeOpacitySlider = new ej.inputs.Slider({
   ...
   value: 0,
   change: function (args) {
     nodeProperties.opacity = args.value;
...
var lineWidth = new ej.inputs.NumericTextBox({
  ...
  max :10,
  change: function(args) {
      connectorProperties.lineWidth = args.value;
...
var connectorOpacityText = new ej.inputs.Slider({
  min: 0,
  max: 100,
  step: 10,
  type: 'MinRange',
  value: 0,
  change: function (args) {
      connectorProperties.m_opacity.value= args.value;
      PropertyChange.prototype.connectorPropertyChange({ propertyName: 'opacity', propertyValue: args });
  }
});
connectorOpacityText.appendTo('#connectorOpacityText');
ConnectorProperties.opacity = connectorOpacityText;
  ...
  if (target && (target.className === 'e-control e-dropdown-btn e-lib e-btn db-dropdown-menu' ||
      ...
      if (button1.getPopUpElement().classList.contains('e-popup-close')) {
          ...
          if (button1.element.id === 'btnArrangeMenu') {
              this.enableArrangeMenuItems(selectedItem);
          }
...
function openUploadBox (isOpen, extensionType) {
  ...
  orgDataSettings.extensionType = defaultUpload.allowedExtensions = extensionType;
...
function onUploadSuccess(args) {
  ...
  if (args.operation !== 'remove') {
      ...
      if (OrgChartUtilityMethods.fileType.toLowerCase() === 'jpg' || OrgChartUtilityMethods.fileType.toLowerCase() === 'png' || OrgChartUtilityMethods.fileType.toLowerCase() === 'svg') {
...
function setImage(event) {
  ...
  var hyperlinkDialog = new ej.popups.Dialog({
    ...
    showCloseIcon: true,
    visible: false,
    buttons: utilityMethods.getDialogButtons('hyperlink'),
  ...
  var exportDialog = new ej.popups.Dialog({
    ...
    content: '<div id="exportDialogContent"><div class="row"><div class="row"> File Name </div> <div class="row db-dialog-child-prop-row">' +
     ...
     '<div class="row db-dialog-prop-row"> <div class="row"> Format </div> <div class="row db-dialog-child-prop-row"> ' +
     '<input type="text" id="exportFormat"/> </div></div></div>' 
});
...
var toolbarTextAlignment = new ej.navigations.Toolbar({
  ...
  items: [
      { prefixIcon: 'sf-icon-align-text-right', tooltipText: 'Align Right', cssClass: 'tb-item-start' },
...
var opacityTextSlider = new ej.inputs.Slider({
  ...
  value: 0,
  change: function (args) {
      textProperties.opacity = args.value;
...
var toolbarEditor = new ej.navigations.Toolbar({
    ...
    items: [
      ...
      {   prefixIcon: 'sf-icon-properties', tooltipText: 'Hide property',template:'<button id="hideProperty" onclick="hideClicked()" ></button>',align:'Right'}
    ]
});
...
document.getElementById('pageSetting').onclick = (args)=>{
  hideElements('hide-properties',diagram);
}
document.getElementById('property').onclick = (args)=>{
  hideElements('hide-properties',diagram);
}
  ...
  var commandType = args.item.tooltipText.replace(/[' ']/g, '').toLowerCase();
   ...
   if (commandType === 'pantool' || commandType === 'selecttool' || commandType === 'texttool'|| commandType === 'straight') {
    if (args.item.cssClass.indexOf('tb-item-selected') === -1) {
      utilityMethods.removeSelectedToolbarItem();
...
function flipObjects(flipType) {
  ...
  for (i = 0; i < selectedObjects.length; i++) {
    selectedObjects[i].flip ^= flipType === 'horizontalflip'? ej.diagrams.FlipDirection.Horizontal:ej.diagrams.FlipDirection.Vertical;
  }
  diagram.dataBind();
}
